...
#   timestamp: 2025-08-27T06:56:09+00:00
...
class AssistantSupportedModels(MyEnum):
    gpt_4_1 = 'gpt-4.1'
...
class AssistantsApiResponseFormatOption1(MyEnum):
    auto = 'auto'


class AssistantsApiToolChoiceOption1(MyEnum):
    none = 'none'
    auto = 'auto'
    required = 'required'
...
class AudioResponseFormat(MyEnum):
    json = 'json'
    text = 'text'
    srt = 'srt'
...
class AuditLogEventType(MyEnum):
...
class ChatCompletionModality(MyEnum):
    text = 'text'
    audio = 'audio'
...
class ChatCompletionResponseMessage(BaseModel):
    ...
    refusal: str | None = Field(..., description='The refusal message generated by the model.')
...
class ChatCompletionRole(MyEnum):
    developer = 'developer'
    system = 'system'
    user = 'user'
    assistant = 'assistant'
...
class ChatCompletionToolChoiceOption1(MyEnum):
    none = 'none'
    auto = 'auto'
    required = 'required'
...
class CreateCompletionResponse(BaseModel):
    ...
    model: Optional[str] = Field(None, description='The model used for completion.')
...
class BatchSize(MyEnum):
    auto = 'auto'


class LearningRateMultiplier(MyEnum):
    auto = 'auto'


class NEpochs(MyEnum):
    auto = 'auto'


class Hyperparameters(BaseModel):
    batch_size: Optional[Union[BatchSize, Annotated[int,Field(ge=1, le=256)]]] = Field(
        BatchSize.auto,
    ...
    n_epochs: Optional[Union[NEpochs, Annotated[int,Field(ge=1, le=50)]]] = Field(
        NEpochs.auto,
...
class Moderation(MyEnum):
    low = 'low'
    auto = 'auto'


class Background(MyEnum):
...
class HateEnum(MyEnum):
    text = 'text'


class HateThreateningEnum(MyEnum):
    text = 'text'


class HarassmentEnum(MyEnum):
    text = 'text'


class HarassmentThreateningEnum(MyEnum):
    text = 'text'


class IllicitEnum(MyEnum):
    text = 'text'


class IllicitViolentEnum(MyEnum):
    text = 'text'


class SelfHarmEnum(MyEnum):
    text = 'text'
    image = 'image'


class SelfHarmIntentEnum(MyEnum):
    text = 'text'
    image = 'image'


class SelfHarmInstruction(MyEnum):
    text = 'text'
    image = 'image'


class SexualEnum(MyEnum):
    text = 'text'
    image = 'image'


class SexualMinor(MyEnum):
    text = 'text'


class ViolenceEnum(MyEnum):
    text = 'text'
    image = 'image'


class ViolenceGraphicEnum(MyEnum):
    text = 'text'
    image = 'image'
...
class TimestampGranularity(MyEnum):
    word = 'word'
    segment = 'segment'
...
class Model10(MyEnum):
    whisper_1 = 'whisper-1'


class ResponseFormat4(MyEnum):
    json = 'json'
    text = 'text'
    srt = 'srt'
    verbose_json = 'verbose_json'
...
class CreateTranslationRequest(BaseModel):
    ...
    model: Optional[Union[str, Model10]] = Field(
        ...,
...
class Object23(MyEnum):
    list = 'list'


class Object24(MyEnum):
...
class Sample(BaseModel):
    ...
    model: Optional[str] = Field(None, description='The model used for generating the sample.')
...
class Hyperparameters1(BaseModel):
    beta: Optional[Union[Beta, Annotated[float,Field(le=2.0, gt=0.0)]]] = Field(
        Beta.auto,
...
class Object27(MyEnum):
    fine_tuning_job = 'fine_tuning.job'


class Status5(MyEnum):
...
class FunctionToolCallOutputResource(FunctionToolCallOutput):
    ...
    type: Literal[Type71.function_call_output] # type: ignore[assignment]


class FunctionToolCallResource(FunctionToolCall):
    id: str | None = Field(..., description='The unique ID of the function tool call.\n')
    type: Literal[Type70.function_call] # type: ignore[assignment]
...
class Object42(MyEnum):
    thread_message = 'thread.message'


class Status10(MyEnum):
    in_progress = 'in_progress'
    incomplete = 'incomplete'
    completed = 'completed'
...
class ModelIdsResponses1(MyEnum):
    o1_pro = 'o1-pro'
...
class Object44(MyEnum):
    file = 'file'


class Purpose2(MyEnum):
    assistants = 'assistants'
...
class Object45(MyEnum):
    organization_project = 'organization.project'


class Status13(MyEnum):
    active = 'active'
    archived = 'archived'
...
class ProjectRateLimit(BaseModel):
    ...
    model: Optional[str] = Field(None, description='The model this rate limit applies to.')
...
class Type103(MyEnum):
    response_create = 'response.create'


class Type104(MyEnum):
    session_update = 'session.update'


class Type105(MyEnum):
    transcription_session_update = 'transcription_session.update'


class Type106(MyEnum):
    message = 'message'
    function_call = 'function_call'
    function_call_output = 'function_call_output'


class Object59(MyEnum):
    realtime_item = 'realtime.item'


class Status14(MyEnum):
    completed = 'completed'
    incomplete = 'incomplete'
...
class Type108(MyEnum):
    message = 'message'
    function_call = 'function_call'
    function_call_output = 'function_call_output'


class Type109(MyEnum):
    input_audio = 'input_audio'
    input_text = 'input_text'
    item_reference = 'item_reference'
    text = 'text'
...
class Object61(MyEnum):
    realtime_response = 'realtime.response'


class Status16(MyEnum):
    completed = 'completed'
    cancelled = 'cancelled'
    failed = 'failed'
    incomplete = 'incomplete'
...
class Modality(MyEnum):
    text = 'text'
    audio = 'audio'


class OutputAudioFormat(MyEnum):
    pcm16 = 'pcm16'
    g711_ulaw = 'g711_ulaw'
    g711_alaw = 'g711_alaw'


class MaxOutputTokens(MyEnum):
    inf = 'inf'


class Type111(MyEnum):
    function = 'function'
...
class MaxResponseOutputTokens(MyEnum):
    inf = 'inf'


class Conversation(MyEnum):
    auto = 'auto'
    none = 'none'


class Type112(MyEnum):
...
class Type133(MyEnum):
    response_content_part_added = 'response.content_part.added'


class Type134(MyEnum):
    audio = 'audio'
    text = 'text'
...
class Type135(MyEnum):
    response_content_part_done = 'response.content_part.done'


class Type136(MyEnum):
    audio = 'audio'
    text = 'text'
...
class Type137(MyEnum):
    response_created = 'response.created'


class Type138(MyEnum):
    response_done = 'response.done'


class Type139(MyEnum):
...
class Type145(MyEnum):
    session_created = 'session.created'


class Type146(MyEnum):
    session_updated = 'session.updated'


class Type147(MyEnum):
    transcription_session_updated = 'transcription_session.updated'


class Model11(MyEnum):
...
class Type148(MyEnum):
    server_vad = 'server_vad'
    semantic_vad = 'semantic_vad'


class Eagerness(MyEnum):
    low = 'low'
    medium = 'medium'
    high = 'high'
    auto = 'auto'
...
class TurnDetection(BaseModel):
    type: Optional[Type148] = Field(
        Type148.server_vad, description='Type of turn detection.\n'
    )
...
class TurnDetection1(BaseModel):
    type: Optional[Type151] = Field(
        Type151.server_vad, description='Type of turn detection.\n'
    )
    eagerness: Optional[Eagerness] = Field(
        Eagerness.auto,
        description='Used only for `semantic_vad` mode. The eagerness of the model to respond. `low` will wait longer for the user to continue speaking, `high` will respond more quickly. `auto` is the default and is equivalent to `medium`.\n',
...
class TurnDetection3(BaseModel):
    type: Optional[Type155] = Field(
        Type155.server_vad, description='Type of turn detection.\n'
    )
    eagerness: Optional[Eagerness] = Field(
        Eagerness.auto,
        description='Used only for `semantic_vad` mode. The eagerness of the model to respond. `low` will wait longer for the user to continue speaking, `high` will respond more quickly. `auto` is the default and is equivalent to `medium`.\n',
...
class Summary(MyEnum):
    auto = 'auto'
    concise = 'concise'
    detailed = 'detailed'


class GenerateSummary(MyEnum):
    auto = 'auto'
    concise = 'concise'
    detailed = 'detailed'


class ReasoningEffort(MyEnum):
    low = 'low'
    medium = 'medium'
    high = 'high'


class Type157(MyEnum):
    reasoning = 'reasoning'


class Type158(MyEnum):
...
class Object62(MyEnum):
    response = 'response'


class Status18(MyEnum):
    completed = 'completed'
    failed = 'failed'
    in_progress = 'in_progress'
    incomplete = 'incomplete'
...
class ResponseCodeInterpreterCallCodeDeltaEvent(BaseModel):
    type: Literal[Type163.response_code_interpreter_call_code_delta] = Field(
        ...,
...
class ResponseCodeInterpreterCallCodeDoneEvent(BaseModel):
    type: Literal[Type164.response_code_interpreter_call_code_done] = Field(
        ...,
...
class Type165(MyEnum):
    response_code_interpreter_call_completed = (
        'response.code_interpreter_call.completed'
    )


class Type166(MyEnum):
    response_code_interpreter_call_in_progress = (
        'response.code_interpreter_call.in_progress'
    )


class Type167(MyEnum):
    response_code_interpreter_call_interpreting = (
        'response.code_interpreter_call.interpreting'
    )


class Type168(MyEnum):
    response_completed = 'response.completed'


class Type169(MyEnum):
    response_content_part_added = 'response.content_part.added'


class Type170(MyEnum):
    response_content_part_done = 'response.content_part.done'


class Type171(MyEnum):
    response_created = 'response.created'


class ResponseErrorCode(MyEnum):
...
class Type172(MyEnum):
    error = 'error'


class ResponseErrorEvent(BaseModel):
    type: Literal[Type172.error] = Field(
...
class Type173(MyEnum):
    response_failed = 'response.failed'


class Type174(MyEnum):
...
class ResponseFileSearchCallCompletedEvent(BaseModel):
    type: Literal[Type174.response_file_search_call_completed] = Field(
        ...,
...
class ResponseFileSearchCallInProgressEvent(BaseModel):
    type: Literal[Type175.response_file_search_call_in_progress] = Field(
        ...,
...
class ResponseFileSearchCallSearchingEvent(BaseModel):
    type: Literal[Type176.response_file_search_call_searching] = Field(
        ...,
...
class Type180(MyEnum):
    response_function_call_arguments_delta = 'response.function_call_arguments.delta'


class ResponseFunctionCallArgumentsDeltaEvent(BaseModel):
    type: Literal[Type180.response_function_call_arguments_delta] = Field(
        ...,
...
class Type181(MyEnum):
    response_function_call_arguments_done = 'response.function_call_arguments.done'


class ResponseFunctionCallArgumentsDoneEvent(BaseModel):
    type: Literal[Type181.response_function_call_arguments_done] = Field(
        ...,
...
class Type182(MyEnum):
    response_in_progress = 'response.in_progress'


class Type183(MyEnum):
    response_incomplete = 'response.incomplete'


class Object63(MyEnum):
    list = 'list'


class ResponseModality(MyEnum):
    text = 'text'
    audio = 'audio'
...
class Type184(MyEnum):
    response_output_item_added = 'response.output_item.added'


class Type185(MyEnum):
    response_output_item_done = 'response.output_item.done'


class Truncation(MyEnum):
    auto = 'auto'
    disabled = 'disabled'


class Type186(MyEnum):
    response_reasoning_summary_part_added = 'response.reasoning_summary_part.added'


class Type187(MyEnum):
    summary_text = 'summary_text'
...
class ResponseReasoningSummaryPartAddedEvent(BaseModel):
    type: Literal[Type186.response_reasoning_summary_part_added] = Field(
        ...,
...
class ResponseReasoningSummaryPartDoneEvent(BaseModel):
    type: Literal[Type188.response_reasoning_summary_part_done] = Field(
        ...,
...
class ResponseReasoningSummaryTextDeltaEvent(BaseModel):
    type: Literal[Type190.response_reasoning_summary_text_delta] = Field(
        ...,
...
class ResponseReasoningSummaryTextDoneEvent(BaseModel):
    type: Literal[Type191.response_reasoning_summary_text_done] = Field(
        ...,
...
class Type194(MyEnum):
    response_output_text_annotation_added = 'response.output_text.annotation.added'


class Type195(MyEnum):
    response_output_text_delta = 'response.output_text.delta'


class ResponseTextDeltaEvent(BaseModel):
    type: Literal[Type195.response_output_text_delta] = Field(
...
class Type196(MyEnum):
    response_output_text_done = 'response.output_text.done'


class ResponseTextDoneEvent(BaseModel):
    type: Literal[Type196.response_output_text_done] = Field(
...
class ResponseWebSearchCallInProgressEvent(BaseModel):
    type: Literal[Type198.response_web_search_call_in_progress] = Field(
        ...,
...
class Object64(MyEnum):
    thread_run = 'thread.run'


class Status19(MyEnum):
    queued = 'queued'
    in_progress = 'in_progress'
...
class Type202(MyEnum):
    code_interpreter = 'code_interpreter'


class Type203(MyEnum):
    image = 'image'
...
class Type207(MyEnum):
    tool_calls = 'tool_calls'


class Type208(MyEnum):
    message_creation = 'message_creation'
...
class Type209(MyEnum):
    code_interpreter = 'code_interpreter'


class Type210(MyEnum):
    image = 'image'
...
class Type215(MyEnum):
    tool_calls = 'tool_calls'


class Object66(MyEnum):
    thread_run_step = 'thread.run.step'


class Type216(MyEnum):
    message_creation = 'message_creation'
    tool_calls = 'tool_calls'


class Status20(MyEnum):
    in_progress = 'in_progress'
    cancelled = 'cancelled'
    failed = 'failed'
    completed = 'completed'
...
class ToolChoiceOptions(MyEnum):
    none = 'none'
    auto = 'auto'
    required = 'required'


class Type224(MyEnum):
    file_search = 'file_search'
...
class TranscriptionInclude(MyEnum):
    logprobs = 'logprobs'
...
class Object77(MyEnum):
    page = 'page'


class Object78(MyEnum):
    bucket = 'bucket'


class Object79(MyEnum):
...
class VectorStoreFileAttributes(
    RootModel[Optional[Dict[str, Union[Annotated[str,Field(max_length=512)], float, bool]]]]
):
    root: Optional[Dict[str, Union[Annotated[str,Field(max_length=512)], float, bool]]] = None


class Object83(MyEnum):
    vector_store_files_batch = 'vector_store.files_batch'


class Status22(MyEnum):
    in_progress = 'in_progress'
    completed = 'completed'
    cancelled = 'cancelled'
    failed = 'failed'
...
class RankingOptions(BaseModel):
    ...
    ranker: Optional[Ranker] = Ranker.auto
    score_threshold: Optional[Annotated[float,Field(ge=0.0, le=1.0)]] = 0
...
class VectorStoreSearchRequest(BaseModel):
    ...
    query: Union[str, Annotated[List[str],Field(min_length=1)]] = Field(
...
class VectorStoreSearchResultsPage(BaseModel):
    ...
    search_query: Annotated[List[str],Field(min_length=1)]
...
class WebSearchContextSize(MyEnum):
    low = 'low'
    medium = 'medium'
    high = 'high'
...
class Type231(MyEnum):
    web_search_call = 'web_search_call'


class Status25(MyEnum):
    in_progress = 'in_progress'
    searching = 'searching'
    completed = 'completed'
    failed = 'failed'
...
class WebSearchToolCall(BaseModel):
    ...
    type: Literal[Type231.web_search_call] = Field(
        ...,
...
class Type233(MyEnum):
    input_image = 'input_image'


class Detail5(MyEnum):
    low = 'low'
    high = 'high'
    auto = 'auto'
...
class RankingOptions1(BaseModel):
    ranker: Optional[Ranker] = Field(
        Ranker.auto, description='The ranker to use for the file search.'
    )
...
class Type235(MyEnum):
    file_search = 'file_search'


class FileSearchTool(BaseModel):
    type: Literal[Type235.file_search] = Field(
...
class Type236(MyEnum):
    function = 'function'


class FunctionTool(BaseModel):
    type: Literal[Type236.function] = Field(
...
class Type238(MyEnum):
    web_search_preview = 'web_search_preview'
    web_search_preview_2025_03_11 = 'web_search_preview_2025_03_11'


class SearchContextSize(MyEnum):
    low = 'low'
    medium = 'medium'
    high = 'high'
...
class WebSearchPreviewTool(BaseModel):
    type: Literal[Type238.web_search_preview, Type238.web_search_preview_2025_03_11] = Field(
        ...,
...
class Type239(MyEnum):
    computer_use_preview = 'computer_use_preview'


class Environment(MyEnum):
    windows = 'windows'
    mac = 'mac'
    linux = 'linux'
    ubuntu = 'ubuntu'
...
class ComputerUsePreviewTool(BaseModel):
    type: Literal[Type239.computer_use_preview] = Field(
        ...,
...
class Type244(MyEnum):
    computer_call_output = 'computer_call_output'


class Status26(MyEnum):
    in_progress = 'in_progress'
    completed = 'completed'
    incomplete = 'incomplete'
...
class FunctionCallOutputItemParam(BaseModel):
    ...
    output: Annotated[str,Field(max_length=10485760)] = Field(
        ..., description='A JSON string of the output of the function tool call.'
    )
    status: Optional[Status26] = None


class Type246(MyEnum):
    item_reference = 'item_reference'
...
class ComputerToolCallOutputResource(ComputerToolCallOutput):
    ...
    type: Literal[Type26.computer_call_output] # type: ignore[assignment]
...
class CreateChatCompletionStreamResponse(BaseModel):
    ...
    model: Optional[str] = Field(None, description='The model to generate the completion.')
    service_tier: Optional[ServiceTier] = ServiceTier.auto
    system_fingerprint: Optional[str] = Field(
        None,
        description='This fingerprint represents the backend configuration that the model runs with.\nCan be used in conjunction with the `seed` request parameter to understand when backend changes have been made that might impact determinism.\n',
...
class CreateCompletionRequest(BaseModel):
    model: Optional[Union[str, Model]] = Field(
        None,
        description='ID of the model to use. You can use the [List models](/docs/api-reference/models/list) API to see all of your available models, or see our [Model overview](/docs/models) for descriptions of them.\n',
    )
...
class CreateEmbeddingResponse(BaseModel):
    ...
    model: Optional[str] = Field(
        None, description='The name of the model used to generate the embedding.'
    )
...
class CreateSpeechRequest(BaseModel):
    ...
    instructions: Optional[Annotated[str,Field(max_length=4096)]] = Field(
        None,
...
class CreateFineTuningJobRequest(BaseModel):
    ...
    suffix: Optional[Annotated[str,Field(min_length=1, max_length=64)]] = Field(
        None,
...
class CreateChatCompletionRequest(CreateModelResponseProperties):
    ...
    seed: Optional[Annotated[int,Field(ge=-9223372036854776000, le=9223372036854776000)]] = Field(
        None,
...
class EvalRun(BaseModel):
    ...
    status: str = Field(..., description='The status of the evaluation run.')
    model: Optional[str] = Field(None, description='The model that is evaluated, if applicable.')
...
class Response1(ModelResponseProperties, ResponseProperties):
    ...
    incomplete_details: Optional[IncompleteDetails1] = Field(
