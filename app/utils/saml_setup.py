...
saml_config = {
    ...
    "contactPerson": {
        "technical": {
            "givenName": "Thomas Pfau",
            "emailAddress": "thomas.pfau@aalto.fi",
        },
        "support": {"givenName": "Thomas Pfau", "emailAddress": "thomas.pfau@aalto.fi"},
    },
    "organization": {
        "en-US": {
            "name": "Aalto SciComp",
            "displayname": "Aalto SciComp",
            "url": "http://scicomp.aalto.fi",
        }
    },
}
