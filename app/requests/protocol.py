...
from typing import Any, ClassVar, Dict, List, Literal, Optional, Set, Union, Iterable
...
from app.utils.chat_utils import ChatCompletionMessageParam, PoolingParams, Logprob
...
class BatchRequestInput(OpenAIBaseModel):
    ...
    def check_type_for_url(cls, value: Any, info: ValidationInfo):
        ...
        return TypeAdapter(
            Union[ChatCompletionRequest, EmbeddingRequest, ScoreRequest]
...
class BatchResponseData(OpenAIBaseModel):
    ...
    body: Optional[Union[ChatCompletionResponse, EmbeddingResponse, ScoreResponse]] = (
        None
    )
